...
"scripts/HudLayout.res"
{
	...
	{ 
      ...
      // xpos and ypos define where the top left corner of the panel will be 
		"xpos"			"c85" //x pos controlled by HudAmmoInfo2
		"ypos"			"447" 
		"zpos"			"2"
   ...
   { 
      ...
      // xpos and ypos define where the top left corner of the panel will be 
      "xpos"         "c-200" // Right in the middle of the damn screen 
      //"xpos"         "130" // Right in the middle of the damn screen 
      "ypos"         "3" 
      "wide"         "640" // This stuff is proportional, so 640x480 is actually the size of the whole screen at any resolution.  Unless, that is, you have a non-4:3 monitor.  Vgui is a pain in the ass to get right then. 
      "tall"         "480" 
       
      "TeamScoreBlue_xpos"       "60" // Note that these positions are relative to the position of the panel 
      "TeamScoreBlue_ypos"       "0"   // i.e. 0,0 is the top left corner of the panel 
	  "TeamScoreRed_xpos"       "300" // Note that these positions are relative to the position of the panel 
      "TeamScoreRed_ypos"       "0"   // i.e. 0,0 is the top left corner of the panel 
	  "TeamScoreYellow_xpos"       "62" // Note that these positions are relative to the position of the panel 
      "TeamScoreYellow_ypos"       "22"   // i.e. 0,0 is the top left corner of the panel 
	  "TeamScoreGreen_xpos"       "298" // Note that these positions are relative to the position of the panel 
   ...
   { 
      ...
      // xpos and ypos define where the top left corner of the panel will be 
      "xpos"         "999" // Right in the middle of the damn screen 20
      "ypos"         "0" //20
      "wide"         "640" // This stuff is proportional, so 640x480 is actually the size of the whole screen at any resolution.  Unless, that is, you have a non-4:3 monitor.  Vgui is a pain in the ass to get right then. 
      "tall"         "480" 
   ...
   { 
      ...
      // xpos and ypos define where the top left corner of the panel will be 
      "xpos"         "999" // Right in the middle of the damn screen 
      "ypos"         "0" // 
      "wide"         "640" // This stuff is proportional, so 640x480 is actually the size of the whole screen at any resolution.  Unless, that is, you have a non-4:3 monitor.  Vgui is a pain in the ass to get right then. 
      "tall"         "480" 
